...
向前:$n\rightarrow n-1$,  假设对$n$成立, $\because\dfrac{1}{n-1}\displaystyle\sum_{i=1}^{n-1} x_i\leq\dfrac{1}{2}\quad\text{由}x_n\text{的任意性},$ \\
...
\begin{ti}
【题5】设数列$\{a_n\}_{n=0}^{\infty}$满足$\displaystyle\lim_{n\to\infty}a_n=a$,证明$\displaystyle\lim_{n\to\infty}\frac{1}{2^n}\sum_{k=0}^{n}\binom{n}{k}a_k=a $
\end{ti}
...
\textbf{注}:本题与题2类似,直接用$Stolz$公式并不好做,取倒数的动机为如果$\displaystyle\lim_{n\to\infty}na_n=1$ 
...
先证明一个引理:$\;0<\varepsilon_n<\dfrac{1}{n!n}$,其中$n\geq1$.由级数展开及几何级数求和,\\

$n!\varepsilon_n=\displaystyle\sum_{j=1}^{\infty}\dfrac{1}{(n+1)(n+2)\cdots(n+j)}<\sum_{j=1}^{\infty}\dfrac{1}{(n+1)^j}=\dfrac{1}{n},$ \\
...
由$Stolz$公式,$\displaystyle\lim_{n\to\infty}x_n=\lim_{n\to\infty}\dfrac{\displaystyle\sum_{k=0}^{n+1}ln\binom{n+1}{k}-\displaystyle\sum_{k=0}^{n}ln\binom{n}{k}}{2n+1}$ \\

$=\displaystyle\lim_{n\to\infty}\dfrac{\displaystyle\sum_{k = 0}^{n}ln\frac{n+1}{n+1-k}}{2n+1},$又由于$2n+1$也是单调递增的正无穷大量, \\

再由$Stolz$公式,$\displaystyle\lim_{n\to\infty}\dfrac{\displaystyle\sum_{k = 0}^{n}\ln\frac{n+1}{n+1-k}}{2n+1}=\lim_{n\to\infty}\dfrac{\displaystyle\sum_{k=0}^{n}\ln\frac{n+1}{n+1-k}-\displaystyle\sum_{k=0}^{n-1}\ln\frac{n}{n-k}}{2}$ \\
