...
假设$n-1$时结论成立,$\;n\geq2$时,设$g(x)=f(x+1)-f(x),$ \\

则$g(0)+g(1)+...+g(n-1)=0,\;\therefore\,g(0),g(1),...g(n-1)$不能恒正或恒负, \\

由$g$的连续性及上式,可取$\displaystyle x_0\in[0,n-1)$使$\displaystyle g(x_0)=0$;否则$g$在$[0,n-1)$上恒正或恒负,与上式矛盾,\\
...
因为$\displaystyle f(x_0)=f(x_0+1)$,所以$\displaystyle h\in C[0,n-1]$;又$\displaystyle x_0<n-1$,故$\displaystyle h(0)=f(0)=f(n)=h(n-1)$, \\
